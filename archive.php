    ...
    <script>
        ...
        createApp({
                    ...
                    return this.data.filter(post => {
                        return post.categories.some(category => {
                            ...
                            if (this.selectedCategory === '') {
                                ...
                                return category
                            } else if (category.slug === this.selectedCategory) {
                                this.filterPost.push(post)
                                this.handlePaginationCalculator;
                                return category
                            }
            ...
            async mounted() {
                ...
                const category = this.locationHref.split('/')[4]
            ...
            methods: {
                ...
                filterCategory(category) {
                    const str = category.normalize("NFD").replace(/[\u0300-\u036f]/g, "");
                    const normalizeStr = str.replace(/\s+/g, '-').toLowerCase();
                    this.selectedCategory = normalizeStr;
                },
